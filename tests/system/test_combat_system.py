...
# System test URLs - support both local and CI environments
# In CI (docker-compose.test.yml), use service names
# Locally, use localhost
COMBAT_API_URL = os.getenv("COMBAT_API_URL", "http://localhost:9000")
...
@pytest.mark.skipif(
    ...
    reason="Combat API not running at localhost:9000. Run 'docker-compose up' first."
)
